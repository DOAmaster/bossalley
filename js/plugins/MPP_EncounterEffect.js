...
/*:
 * @plugindesc 【ver.2.0】Alters an appearance of battle start with dynamic effects.
 ...
 * 
 * ※ Variables can be used for the value specified by the plugin command.
 ...
 *  〇 Effect Type
 *   0 : Default
 *   1 : Split around the character
 *   2 : Split from the right or left of the screen
 *   3 : The whole screen scattered to the front
 * 
 * --------------------------------
 *  〇 Clipping Mode
 *   This plugin uses an effect of background image turn into many fragments.
 *   
 *   When fragmented image is displayed, a process called [Crop out] is performed,
 *   but it is a parameter to reduce the memory by simplifying the process.
 *   
 *   You probably don't mind turning it to OFF.
 * 
 * --------------------------------
 *  〇 Advanced Settings
 *   No change is required.
 *   
 *   Because it's difficult to explain each parameter in sentences.
 *   I guess from the parameter name and make it operate and check.
 * 
 * --------------------------------
 *  〇 Plugin Commands
 *   You can change the plugin command name or the command name used in the Note box.
 *   You can shorten the command or keep it Japanese.
 *   
 *   The default command can be used even if you change the command name.
 * 
 * 
 * ================================================================
 * ▼Information
 ...
 * @type number
 * @max 3
 * @desc Screen break effect type
 * @default 1
 * @parent === Basic ===
 * 
 * @param Type 1 Params
 * @type struct<Type1>
 * @desc Type 1 parameter
 ...
 * @type number
 * @desc Screen shift rate when the screen breaks (%)
 * @default 100
 * @parent === Advanced ===
 * 
 * @param Pc Zoom
 ...
 * @min 1
 * @decimals 2
 * @desc Image magnification for PC
 * @default 2.00
 * @parent === Advanced ===
 * 
 * @param Mobile Zoom
 ...
 * @min 1
 * @decimals 2
 * @desc Image magnification for a portable device
 * @default 4.00
 * @parent === Advanced ===
 * 
 * @param Smooth Mode
 ...
 * @option Pc Only
 * @option OFF
 * @desc Smooth depiction of the image
 * @default Pc Only
 * @parent === Advanced ===
 * 
 * 
 ...
 * @type number
 * @min 1
 * @desc Screen break effect time
 * @default 45
 * 
 * @param Break Duration 2
 * @type number
 * @min 1
 * @desc Standby time after screen break
 * @default 40
 ...
 * @type number
 * @min 1
 * @desc Effect time at start of battle
 * @default 60
 * @parent Break Duration 1
 * 
 * @param Split Radial
 * @type number
 * @min 3
 * @desc Number of divide radially
 * @default 10
 * 
 * @param Radial Random Rate
 * @type number
 * @max 100
 * @desc Random rate of dividing radially
 * (0～100%)
 * @default 90
 * @parent Split Radial
 * 
 ...
 * @type number
 * @min 1
 * @desc Basic radius of dividing into circles
 * @default 96
 * 
 * @param Circle Increase Rate
 * @type number
 * @desc Increase rate of dividing into circles (%)
 * @default 150
 ...
 * @type number
 * @max 100
 * @desc Random rate of dividing into circles
 * (0～100%)
 * @default 40
 * @parent Circle Radius
 * 
 ...
 * @max 2
 * @desc Fragment shape
 * (0: rectangle, 1: triangle, 2: random)
 * @default 2
 * 
 * @param Break Duration 1
 * @type number
 * @min 1
 * @desc Screen break effect duration
 * @default 30
 * 
 * @param Break Duration 2
 * @type number
 ...
 * @option center point
 * @option right
 * @desc Direction of the screen breaks
 * @default left
 * 
 ...
 * @option left
 * @option right
 * @desc Direction of the screen scattered
 * @default left
 * 
 * @param Split X
 * @type number
 * @min 3
 * @desc Number of split horizontally
 * @default 10
 * 
 * @param X Random Rate
 * @type number
 * @max 100
 * @desc Random rate of dividing horizontally
 * (0～100%)
 * @default 80
 * @parent Split X
 * 
 ...
 * @type number
 * @min 1
 * @desc Number of split vertically
 * @default 6
 * 
 * @param Y Random Rate
 * @type number
 * @max 100
 * @desc Random rate of dividing vertically
 * (0～100%)
 * @default 80
 * @parent Split Y
 * 
 ...
 * @type number
 * @min 1
 * @desc Effect duration at start of battle
 * @default 70
 * @parent Break Duration 1
 * 
 * @param Split X
